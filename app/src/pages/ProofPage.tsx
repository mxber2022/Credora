...
import { ProofGeneration } from '../components/sections/ProofGeneration';
...
export function ProofPage({ userData, onProofGenerated }: ProofPageProps) {
  return (
    <div className="min-h-screen py-8 relative bg-black">
      ...
      <div className="relative z-10">
        <ProofGeneration userData={userData} onProofGenerated={onProofGenerated} />
      </div>
    </div>
  );
}