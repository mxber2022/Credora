...
import { Shield, Github, Twitter, Globe, ArrowRight, Sparkles } from 'lucide-react';
            ...
            <div>
              <div className="flex items-center space-x-3 mb-4 group">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500 group-hover:text-gray-400 transition-colors duration-300">Privacy-First Lending</div>
                </div>
              </div>
              
              <p className="text-gray-400 mb-6 text-sm leading-relaxed max-w-md">
                Revolutionary undercollateralized lending using zero-knowledge proofs. 
                Verify income, preserve privacy, access instant credit.
              </p>
            ...
            <div className="text-center lg:text-right space-y-4">
              <div className="group">
                ...
                <p className="text-sm text-gray-400 leading-relaxed group-hover:text-gray-300 transition-colors duration-300">
                  Zero-knowledge proofs for secure, private credit access
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center justify-center lg:justify-end space-x-4">
                  <span className="text-sm font-medium text-gray-400 hover:text-blue-400 transition-colors duration-300 cursor-default">ZKPDF</span>
                  <span className="text-gray-400">•</span>
                  <span className="text-sm font-medium text-gray-400 hover:text-green-400 transition-colors duration-300 cursor-default">PYUSD</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 border-t border-white/15 mt-8 pt-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
              <div className="text-gray-400 text-xs hover:text-gray-300 transition-colors duration-300">
                © 2024 Credora. Built for the future of DeFi.
              </div>
